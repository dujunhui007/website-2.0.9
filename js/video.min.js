!function (t, e) {
  ...
  function A(t) {
    ...
    var n = ce.documentElement, r = ce.body, i = n.clientLeft || r.clientLeft || 0, o = ie.pageXOffset || r.scrollLeft,
      s = e.left + o - i, a = n.clientTop || r.clientTop || 0, l = ie.pageYOffset || r.scrollTop, c = e.top + l - a;
  ...
  function Dt(t, e, n) {
    ...
    var s = "", a = !1, l = t, c = e, u = n, h = null, p = "", d = !0, f = "auto", v = "start", y = 50, g = "middle",
      m = 50, _ = "middle";
  ...
  var ce = re, ue = ie.navigator && ie.navigator.userAgent || "", he = /AppleWebKit\/([\d.]+)/i.exec(ue),
    pe = he ? parseFloat(he.pop()) : null, de = /iPad/i.test(ue), fe = /iPhone/i.test(ue) && !de, ve = /iPod/i.test(ue),
    ye = fe || de || ve, ge = function () {
  ...
  var hn = function (t) {
    ...
    return t.prototype.dispose = function () {
      ...
      var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : t,
        r = this.player_.language && this.player_.language(), i = this.player_.languages && this.player_.languages(),
        o = i && i[r], s = r && r.split("-")[0], a = i && i[s], l = n;
  ...
  var ri = function (t) {
    ...
    return De(e, t), e.prototype.createEl = function () {
      ...
      var e = this.player_.buffered(), n = this.player_.duration(), r = this.player_.bufferedEnd(), i = this.partEls_,
        o = function (t, e) {
          var n = t / e || 0;
          return 100 * (n >= 1 ? 1 : n) + "%"
        };
